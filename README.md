...
$$
Depending on the specific scenario, components of this equation such as \textbf{$L_{tr}$}, may appear multiple times. We denote them as \textbf{$L_{tr1}$}, \textbf{$L_{tr2}$} and so forth. Futhermore in fat client scenario, we don't have any data stream transmission latency, thus \textbf{$L_{tr}$} = 0.
### 1. Fat Client
$$
