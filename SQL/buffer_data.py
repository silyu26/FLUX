...
def save_experiment_to_buffer(exp: Experiment):
    ...
    data = {
        ...
        "exp_id": exp.exp_id,
        "req_id": exp.req_id,
        "server_in": exp.server_in.isoformat() if exp.server_in else None,
        "server_out": exp.server_out.isoformat() if exp.server_out else None,
        "model_in": exp.model_in.isoformat() if exp.model_in else None,
        "model_out": exp.model_out.isoformat() if exp.model_out else None,
        "db_in": exp.db_in.isoformat() if exp.db_in else None,
