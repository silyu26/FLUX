...
def save_experiment_to_buffer(exp: Experiment):
    ...
    data = {
        ...
        "gpu_vram_usage": exp.gpu_vram_usage if exp.gpu_vram_usage else None,
        "gpu_temperature": exp.gpu_temperature if exp.gpu_temperature else None,
        "gpu_power": exp.gpu_power if exp.gpu_power else None,
